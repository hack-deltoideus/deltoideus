...
<nav class="section-nav" aria-label="App sections">
	<a class:active={isActive('/app')} class="section-link" href="/app">
	...
	<a class:active={isActive('/app/ecg')} class="section-link" href="/app/ecg">
